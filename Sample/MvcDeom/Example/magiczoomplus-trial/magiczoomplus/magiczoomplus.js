...
var MagicZoomPlus = (function (g) {
    ...
    c.zoom.prototype = {
        ...
        z26: function (k) {
            var e,
			l,
			j = new RegExp("zoom\\-id(\\s+)?:(\\s+)?" + this.c.id + "($|;)");
            this.selectors = $mjs([]);
        ...
        stop: function (j) {
            try {
                ...
                if (undefined === j) {
                    ...
                    this.hint = null;
                    this.z7.unload(); (this.z4 && this.z4.self) && this.c.removeChild(this.z4.self); (this.z47 && this.z47.self) && this.z47.self.parentNode.removeChild(this.z47.self);
                    this.z4 = null;
                    this.z47 = null;
                    this.z1 = null;
                    this.z7 = null;
        ...
        swap: function (e, l) {
            ...
            u = function (z, A) {
                ...
                if ("" != this._o.selectorsClass) {
                    (A.selector || A.r).j3(this._o.selectorsClass); (this.selector || this.r).j2(this._o.selectorsClass)
                }
            };
            if (!l) {
                if (x.hint) {
