<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kroppr v1.4.aspx.cs" Inherits="MvcSite.kroppr" %>
...
<body>
    <div id="kdiv_rotate" class="tip" title="旋转">
        ...
        <div id="slider_rotate">
            <img src="/kroppr/knob_v.gif" id="knob_rotate" />
        </div>
        <span>360&deg;</span>
    </div>
    <div id="kdiv_zoom" class="tip" title="放大">
        <span>+</span>
        <div id="slider_zoom">
            <img src="/kroppr/knob_v.gif" id="knob_zoom" />
        </div>
        <span >-</span>
    </div>
    ...
    <div id="result" style="position:absolute; left:0; bottom:0; padding:10px;">
        <img src="kroppr/50.jpg" class="kroppr" id="kroppr" />
    </div>
</body>
</html>