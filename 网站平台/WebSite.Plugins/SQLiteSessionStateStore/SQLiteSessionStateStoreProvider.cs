...
namespace WebSite.Plugins
{
    public class SQLiteSessionStateStoreProvider : SessionStateStoreProviderBase
    {
        ...
        /// </summary>
        public Boolean WriteExceptionsToEventLog { get; set; }
        ...
        public override void Initialize(String name, NameValueCollection config)
        {
            ...
            //if (currentContext != null) databaseFile = currentContext.Server.MapPath(databaseFile);

            //_connectionString = "Data Source =" + databaseFile;

            _connectionString = "Data Source=|DataDirectory|ASPState.db;Version=3;Cache Size=8000;Page Size=4096;Synchronous=Off;journal mode=Off;";
        ...
        public override void SetAndReleaseItemExclusive(HttpContext context, String id, SessionStateStoreData item, Object lockId, Boolean newItem)
        {
            ...
            if (newItem)
            {
                ...
                cmd.Parameters.Add(SQLiteHelper.CreateParameter("@SessionItems", DbType.Binary, sessItems));
        ...
        /// </summary>
        public override SessionStateStoreData GetItem(HttpContext context, String id, out Boolean locked, out TimeSpan lockAge, out Object lockId, out SessionStateActions actionFlags)
        {
        ...
        /// </summary>
        public override SessionStateStoreData GetItemExclusive(HttpContext context, String id, out Boolean locked, out TimeSpan lockAge, out Object lockId, out SessionStateActions actionFlags)
        {
        ...
        private SessionStateStoreData GetSessionStoreItem(Boolean lockRecord, HttpContext context, String id, out Boolean locked, out TimeSpan lockAge, out Object lockId, out SessionStateActions actionFlags)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    if (val != DBNull.Value) serializedItems = (Byte[])val;
        ...
        private SessionStateStoreData Deserialize(HttpContext context, Byte[] serializedItems, int timeout)
        {
            ...
            using (MemoryStream ms = new MemoryStream(serializedItems))
            {
                if (ms.Length > 0)
                {
        ...
        public override void CreateUninitializedItem(HttpContext context, String id, int timeout)
        {
            ...
            cmd.Parameters.Add(SQLiteHelper.CreateParameter("@Locked", DbType.Boolean, false));
            cmd.Parameters.Add(SQLiteHelper.CreateParameter("@SessionItems", DbType.Binary, null));
