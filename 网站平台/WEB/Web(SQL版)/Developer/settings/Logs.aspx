    ...
    <script type="text/javascript">
        ...
        window.addEvent('domready', function () {
            ...
            $(li[3]).addEvent('click', function () {
                dialogConfirm({ el: '#btnCommand', text: '确定要清空所有操作日志吗?', data: -2 });
            });
        });
    </script>
</head>
...
<form id="form1" runat="server">
    ...
    <div class="ui-widget-header ui-helper-clearfix" style="background-image:none;">
        <table cellpadding="4" cellspacing="0">
            <tr>
                <td>类型:</td>
                <td>
                    <asp:DropDownList ID="dropGroup" Width="100" runat="server"></asp:DropDownList>
                </td>
                <td>时间:</td>
    ...
    <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand" onitemdatabound="Repeater1_ItemDataBound">
        ...
        <ItemTemplate>
            <tr style="text-align: center;">
                ...
                <td>
                    <%#Enum.Parse(typeof(LogsAction), Eval("actiontype").ToString(), true) %>
                </td>
                <td>
    ...
    CustomInfoHTML="共<font color='red'><b>%RecordCount%</b></font>条信息,<b><font color='red'>%CurrentPageIndex%</font>/%PageCount%</b>页,每页%PageSize%条信息" 
        PageSize="15" CssClass="black2" PagingButtonSpacing="0px" ShowCustomInfoSection="Right" 
