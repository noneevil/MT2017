        ...
        window.addEvent('domready', function () {
            ...
            $(li[2]).addEvent('click', function () {
                ...
                new Request.JSON({
                    ...
                    headers: { Action: 'backup_data' },
                    onRequest: function () {
                        jQuery(".ui-dialog-titlebar,.ui-dialog-buttonpane").hide();
                        jQuery('#loading-text').html('程序正在备份中,请稍后...');
                        _dialog.dialog('open');
                    },
            ...
            $(li[3]).addEvent('click', function () {
                ...
                if (count == 0) {
                    ...
                    dialogConfirm({ el: '#btnCommand', text: '选中的文件将被删除且无法恢复!确定要删除吗?', data: -1 });
                }
            });
        });
    </script>
...
<form runat="server">
    ...
    <asp:Repeater ID="Repeater1" runat="server" 
        ...
        <HeaderTemplate>
            <table class="table" border="0" width="100%" bordercolor="#CCCCCC" cellpadding="4" cellspacing="0">
                <thead>
                    <tr>
        ...
        <ItemTemplate>
            <tr style="text-align:center;">
                ...
                <td align="left">
                    <img align="absmiddle" style="margin-right:5px;" src="../skin/files/rar_small.png" /><label><%#Eval("name")%></label>
                </td>
                <td><%#Eval("CreationTime")%></td>
                <td><%#FileHelper.FileSizeToStr((long)(Eval("Length")))%></td>
                <td>
                    <asp:ImageButton CssClass="img" ImageUrl="../skin/icos/disk_min.gif" runat="server" ToolTip="保存" CommandName="save" />
