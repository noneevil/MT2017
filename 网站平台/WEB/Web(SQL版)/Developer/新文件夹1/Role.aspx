    ...
    <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand" onitemdatabound="Repeater1_ItemDataBound">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td><%#Eval("name") %></td>
                <td><%#Eval("Remark")%></td>
                <td align="center"><i style="cursor:pointer;" title="设置权限" class="icon0-feather" onclick="javascript:dialogIFrame({url:'Role_Power.aspx?id=<%#Eval("id") %>',title:'权限设置 - <%#Eval("name") %>', width: 660, height: 505});return false;"></i></td>
                <td align="center">
                    <input class="img" type="image" src="images/icos/write_enabled.gif" onclick="javascript:dialogIFrame({url:'Role_Edit.aspx?id=<%#Eval("id") %>',title:'修改 - <%#Eval("name") %>', width: 350, height: 250});return false;" title="修改" />
