<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Comment.aspx.cs" Inherits="WebSite.Web.Comment" %>
...
<form id="form1" runat="server">
    <div class="head"><i class="icon0-comments"></i>评论管理</div>
    ...
    <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand" onitemdatabound="Repeater1_ItemDataBound">
        ...
        <ItemTemplate>
            <tr style="text-align:center;">
                ...
                <td>
                    <asp:ImageButton ID="audit" runat="server" ImageUrl="images/icos/checkbox_no.png" ToolTip="审核" CommandName="audit" CommandArgument='<%#Eval("Audit") %>' />
                </td>
                <td>
                    <input id="detail" runat="server" class="img" type="image" src="images/icos/ico_document.png" title="查看详细" />
