    ...
    <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand" onitemdatabound="Repeater1_ItemDataBound">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td align="center">
                        <asp:PlaceHolder ID="PlaceHolder1" runat="server">
                            <a href="<%#Eval("LinkSrc") %>?lightbox[width]=<%#Eval("width") %>&lightbox[height]=<%#Eval("height") %>" rel="group1" class="lightbox">
                                <img src="images/icos/ico_preview.png" />
                            </a>
                        </asp:PlaceHolder>
                        <asp:PlaceHolder ID="PlaceHolder2" runat="server" Visible="false">
                            <a href="system/AdPreview.aspx?src=<%#Eval("LinkSrc") %>&lightbox[iframe]=true&lightbox[width]=<%#Eval("width") %>&lightbox[height]=<%#Eval("height") %>" class="lightbox">
                                <img src="images/icos/ico_preview.png" />
                            </a>
                        </asp:PlaceHolder>
                </td>
                ...
                <td align="center">
                    <input class="img" type="image" src="images/icos/write_enabled.gif" onclick="javascript:dialogIFrame({url:'Ad_Edit.aspx?id=<%#Eval("id") %>',title:'修改 - <%#Eval("title") %>',width:400,height:380});return false;" title="修改" />
