    ...
    <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand" onitemdatabound="Repeater1_ItemDataBound">
        ...
        <ItemTemplate>
            <tr style="text-align:center;">
                ...
                <td>
                    <asp:ImageButton ID="status" runat="server" ImageUrl="images/icos/checkbox_no.png" ToolTip="审核" CommandName="status" CommandArgument='<%#Eval("status") %>' />
                </td>
                <td>
                    <input id="detail" runat="server" class="img" type="image" src="images/icos/mail_close.png" title="查看详细" />
