    ...
    <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand" onitemdatabound="Repeater1_ItemDataBound">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td align="center">
                    <input class="img" type="image" src="images/icos/write_enabled.gif" onclick="javascript:dialogIFrame({url:'Links_Edit.aspx?id=<%#Eval("id") %>',title:'修改 - <%#Eval("linkname") %>'});return false;" title="修改" />
