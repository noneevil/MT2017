    ...
    <script type="text/javascript">
        jq(function () {
            ...
            jq(li[2]).bind('click', function () {
                dialogIFrame({ url: 'User_Edit.aspx', title: '创建用户', width: 400, height: 380 });
            });
            /*启用*/
    ...
    <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand" onitemdatabound="Repeater1_ItemDataBound">
        ...
        <ItemTemplate>
            <tr style="text-align:center;">
                <td align="left"><asp:CheckBox ID="ID" runat="server" Text='<%#Eval("id") %>' /></td>
                <td align="left"><%#Eval("UserName")%></td>
                <td align="left"><%#Eval("Name")%></td>
                <td>
                    <asp:ImageButton ID="reset" runat="server" ImageUrl="images/icos/lock_enable.gif" CommandName="reset" ToolTip="重置密码" />
                </td>
                <td>
                    <asp:ImageButton ID="status" runat="server" ImageUrl="images/icos/checkbox_no.png" ToolTip="启用/禁用" CommandName="status" />
                </td>
                <td>
                    <input class="img" type="image" src="images/icos/write_enabled.gif" onclick="javascript:dialogIFrame({url:'User_Edit.aspx?id=<%#Eval("id") %>',title:'修改 - <%#Eval("UserName") %>', width: 400, height: 380});return false;" title="修改" />
