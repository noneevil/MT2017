...
<head runat="server">
    ...
    <!--[if lte IE 7]><script src="Plugins/fontsicon/lte-ie7.js" type="text/javascript"></script><![endif]-->
    ...
    <script src="Plugins/jQuery/jquery-2.0.3.min.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            ...
            jQuery("#dialog-link, #icons li").hover(function () {
...
<div id="tabs">
	...
	<div id="tabs-4">4 dui erat, auctor a, dignissim quis, sollicitudin eu, felis. Pellentesque nisi urna, interdum eget, sagittis et, consequat vestibulum, lacus. Mauris porttitor ullamcorper augue.</div>
</div>
