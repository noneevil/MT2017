...
CKEDITOR.editorConfig = function (config) {
    ...
    //上传配置
    config.filebrowserBrowseUrl = location.hash + '/Developer/ckfinder/ckfinder.html'; //上传文件时浏览服务文件夹
    config.filebrowserImageBrowseUrl = location.hash + '/Developer/ckfinder/ckfinder.html?Type=图片文件'; //上传图片时浏览服务文件夹
    config.filebrowserFlashBrowseUrl = location.hash + '/Developer/ckfinder/ckfinder.html?Type=Flash动画'; //上传Flash时浏览服务文件夹
    config.filebrowserUploadUrl = location.hash + '/Developer/ckfinder/core/connector/aspx/connector.aspx?command=QuickUpload&type=%e6%96%87%e6%a1%a3%e6%96%87%e4%bb%b6'; //上传文件按钮(标签)
    config.filebrowserImageUploadUrl = location.hash + '/Developer/ckfinder/core/connector/aspx/connector.aspx?command=QuickUpload&type=%e5%9b%be%e7%89%87%e6%96%87%e4%bb%b6'; //上传图片按钮(标签)
    config.filebrowserFlashUploadUrl = location.hash + '/Developer/ckfinder/core/connector/aspx/connector.aspx?command=QuickUpload&type=Flash%e5%8a%a8%e7%94%bb'; //上传Flash按钮(标签)
    ...
    config.toolbar_DIY = [
        ...
        'NumberedList', 'BulletedList', 'Outdent', 'Indent', '-', 'Subscript', 'Superscript', '-', 'Cut', 'Copy', 'Paste', 'PasteText', 'PasteFromWord', '-',
         ...
         ['Styles', 'Format', 'Font', 'FontSize', 'TextColor', 'BGColor', 'Table', 'Image', 'Flash', 'Link',
          'Unlink', 'Anchor', 'SpecialChar', 'Blockquote', 'Undo', 'Redo', 'Word']
    ];
