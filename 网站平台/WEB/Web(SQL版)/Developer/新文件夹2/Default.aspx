...
<head>
    ...
    <script src="Plugins/jquery.nicescroll/jquery.nicescroll.min.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            if ('undefined' == typeof (document.body.style.maxHeight)) {
                window.location.href = 'plug-in/ie6update.html';
            }
        ...
        function loadMenuTree(_islink) {
            ...
            $.ajax({
                type: "post",
                url: "Plug-in/Ajax.ashx?action=get_navigation_list&time=" + Math.random(),
                dataType: "html",
