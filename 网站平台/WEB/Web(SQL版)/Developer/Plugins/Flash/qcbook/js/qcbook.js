function FlippingBook() {
	...
	this.settings = {
			...
			backgroundImage: "/flash/img/bookBackground.jpg",
...
FlippingBook.prototype.create = function(){
	...
	swfobject.embedSWF("/flash/qcbook.swf", this.containerId, this.stageWidth, this.stageHeight, "8.0.0", "/flash/js/expressInstall.swf", this.settings, { allowScriptAccess: "always", bgcolor: "#" + this.settings.backgroundColor.toString(16) });
}
