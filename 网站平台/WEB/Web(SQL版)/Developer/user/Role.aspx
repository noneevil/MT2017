<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Role.aspx.cs" Inherits="WebSite.Web.Role" %>
    ...
    <script type="text/javascript">
        window.addEvent('domready', function () {
            ...
            $(li[2]).addEvent('click', function () {
                dialogIFrame({ url: 'Role_Edit.aspx', title: '创建角色', width: 350, height: 250 });
            });
            /*删除*/
...
<form id="form1" runat="server">
    <div class="head"><i class="icon0-user-4"></i>角色管理</div>
    ...
    <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand" onitemdatabound="Repeater1_ItemDataBound">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td><%#Eval("Remark")%></td>
                <td align="center">
                    <a href="Role_Power.aspx?id=<%#Eval("id") %>"><i class="icon0-feather"></i></a>
                </td>
                <td align="center">
                    <input class="img" type="image" src="../skin/icos/write_enabled.gif" onclick="javascript:dialogIFrame({url:'Role_Edit.aspx?id=<%#Eval("id") %>',title:'修改 - <%#Eval("name") %>', width: 350, height: 250});return false;" title="修改" />
