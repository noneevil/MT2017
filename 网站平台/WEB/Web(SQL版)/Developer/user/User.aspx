<%@ Page Language="C#" AutoEventWireup="true" CodeFile="User.aspx.cs" Inherits="WebSite.Web.User" %>
    ...
    <script type="text/javascript">
        window.addEvent('domready', function () {
            ...
            $(li[2]).addEvent('click', function () {
                dialogIFrame({ url: 'User_Edit.aspx', title: '创建用户', width: 500, height: 450 });
            });
            /*启用*/
...
<form id="form1" runat="server">
    <div class="head"><i class="icon0-users-2"></i>用户管理</div>
        ...
        <ItemTemplate>
            <tr style="text-align:center;">
                <td align="left">
                    ...
                    <asp:HiddenField ID="hidName" runat="server" Value='<%#Eval("UserName") %>' />
                </td>
                <td align="left"><%#Eval("UserName")%></td>
                <td align="left"><%#Eval("Name")%></td>
                <td>
                    <asp:ImageButton ID="reset" runat="server" ImageUrl="../skin/icos/lock_enable.gif" ToolTip="重置密码" CommandName="reset" />
                </td>
                <td>
                    <asp:ImageButton ID="islock" runat="server" ImageUrl="../skin/icos/checkbox_no.png" ToolTip="启用/禁用" CommandName="lock" />
                </td>
                <td>
                    <input class="img" type="image" src="../skin/icos/write_enabled.gif" onclick="javascript:dialogIFrame({url:'User_Edit.aspx?id=<%#Eval("id") %>',title:'修改 - <%#Eval("UserName") %>', width: 500, height: 450});return false;" title="修改" />
