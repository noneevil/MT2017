    ...
    <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand" onitemdatabound="Repeater1_ItemDataBound">
        ...
        <ItemTemplate>
            <tr style="text-align:center;">
                ...
                <td>
                    <asp:ImageButton ID="audit" runat="server" ImageUrl="../skin/icos/checkbox_no.png" ToolTip="审核" CommandName="audit" CommandArgument='<%#Eval("Audit") %>' />
                </td>
                <td>
                    <input id="detail" runat="server" class="img" type="image" src="../skin/icos/ico_document.png" title="查看详细" />
