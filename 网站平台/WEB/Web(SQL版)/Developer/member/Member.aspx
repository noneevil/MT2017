    ...
    <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand" onitemdatabound="Repeater1_ItemDataBound">
        ...
        <ItemTemplate>
            <tr style="text-align:center;">
                ...
                <td align="left">
                    <%#Eval("MemberName")%>
                    <asp:Image ID="ValidateMail" ToolTip="未通过邮箱验证" ImageUrl="../skin/icos/email-disable.png" runat="server" />
                    <asp:Image ID="ValidateMobile" ToolTip="未通过手机验证" ImageUrl="../skin/icos/mobile-disable.png" runat="server" />
                ...
                <td>
                    <asp:ImageButton ID="status" runat="server" ImageUrl="../skin/icos/checkbox_no.png" ToolTip="启用" CommandName="status" CommandArgument='<%#Eval("status") %>' />
                </td>
                <td>
                    <%#Eval("JoinDate", "{0:yyyy-MM-dd}")%>
                </td>
                <td>
                    <input class="img" type="image" src="../skin/icos/info.gif" onclick="javascript:dialogIFrame({url:'Member_Edit.aspx?id=<%#Eval("id") %>',title:'会员资料 - <%#Eval("MemberName") %>',width:650, height: 530});return false;" title="查看详细" />
