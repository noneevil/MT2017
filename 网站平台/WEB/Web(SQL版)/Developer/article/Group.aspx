    ...
    <script type="text/javascript">
        window.addEvent('domready', function () {
            ...
            $(li[2]).addEvent('click', function () {
                location.href = 'Group_Edit.aspx?table=<%:Request["table"] %>';
            });
            /*删除*/
    ...
    <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand" onitemdatabound="Repeater1_ItemDataBound">
        ...
        <ItemTemplate>
            <tr style="text-align: center;">
                ...
                <td>
                    <%#Enum.Parse(typeof(SiteTemplate), Eval("Template").ToString(), true)%>
                </td>
                <td>
                    <a href="Group_Edit.aspx?table=<%:Request["table"] %>&id=<%#Eval("id") %>"><img alt="修改" src="../skin/icos/write_enabled.gif" /></a>
