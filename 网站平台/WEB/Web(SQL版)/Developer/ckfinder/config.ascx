<%@ Control Language="C#" EnableViewState="false" AutoEventWireup="false" Inherits="WebSite.Controls.Settings.ConfigFile" %>
<%@ Import Namespace="WebSite.Controls.Settings" %>
<script runat="server">
    ...
    public override bool CheckAuthentication()
    {
        ...
        //if (!String.IsNullOrEmpty(Admin.Name)) return true;
        //return false;
    ...
    public override void SetConfig()
    {
        ...
        type = ResourceType.Add("文档文件");
        type.Url = BaseUrl + "UpFiles/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "UpFiles/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "7z", "aiff", "asf", "avi", "csv", "doc", "docx", "fla", "gz", "gzip", "ods", "odt", "pdf", "ppt", "pptx", "pxd", "qt", "ram", "rar", "rtf", "sdc", "sitd", "sxc", "sxw", "tar", "tgz", "tif", "tiff", "txt", "vsd", "xls", "xlsx", "zip" };
        type.DeniedExtensions = new string[] { };

        type = ResourceType.Add("图片文件");
        type.Url = BaseUrl + "UpFiles/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "UpFiles/";
        type.MaxSize = 0;
        ...
        type = ResourceType.Add("Flash动画");
        type.Url = BaseUrl + "UpFiles/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "UpFiles/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "swf" };
        type.DeniedExtensions = new string[] { };

        type = ResourceType.Add("音乐视频");
        type.Url = BaseUrl + "UpFiles/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "UpFiles/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "flv", "rm", "rmi", "rmvb", "mid", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg", "wav", "wma", "wmv" };
        type.DeniedExtensions = new string[] { };

        type = ResourceType.Add("广告文件");
        type.Url = BaseUrl + "UpFiles/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "UpFiles/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "flv", "mp4", "swf", "gif", "jpg", "jpeg", "png" };
        type.DeniedExtensions = new string[] { };
    }
