		...
		ym_head);
            ...
            Dialog.apply(Dialog, {
                ...
                show: function(args, fargs, show) { //如果有窗口未关闭则将本次传入的信息放到队列里
                    ...
                    Dialog.apply(curCfg, Dialog.apply({}, o, fargs), Dialog.setDefaultCfg()); //先还原默认配置
                ...
                setDefaultCfg: function(cfg) {
                    return Dialog.cfg = Dialog.apply({}, cfg, Dialog.apply({}, Dialog.cfg, dftCfg));
                },
                getButtons: function() {
