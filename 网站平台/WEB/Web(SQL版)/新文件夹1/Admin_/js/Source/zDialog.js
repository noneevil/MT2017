var IMAGESPATH = '/Developer/images/';
...
var Dialog = function() {
    ...
    this.MessageIcon = "dialog_window.gif";
    this.MessageTitle = "";
    this.Message = "";
...
<td height="33" style="background-image:url(' + IMAGESPATH + 'dialog_ct.png) !important;background: url(' + IMAGESPATH + 'dialog_ct.gif) repeat-x top;"><div style="padding: 9px 0 0 4px; float: left; font-weight: bold; color:#fff;"><img align="absmiddle" src="' + IMAGESPATH + 'dialog_dialog.gif"/><span id="_Title_' + this.ID + '">' + this.Title + '</span></div>\
...
Dialog.getBgdiv = function() {
    ...
    if (!bgdiv) {
        ...
        var bgIframeMask = '<div id="_DialogBGMask" style="position:absolute;background-color:#000;opacity:0.4;filter:alpha(opacity=40);width:100%;height:100%;"></div>';
...
<tr><td align="right"><img id="Icon_' + this.ID + '" src="' + IMAGESPATH + 'dialog_alert.gif" width="34" height="34" align="absmiddle"></td>\
...
h = h || 110;
    ...
    diag.InnerHtml = '<table height="100%" border="0" align="center" cellpadding="10" cellspacing="0">\
<tr><td align="right"><img id="Icon_' + this.ID + '" src="' + IMAGESPATH + 'dialog_query.gif" width="34" height="34" align="absmiddle"></td>\
<td align="left" id="Message_' + this.ID + '" style="font-size:9pt">' + msg + '</td></tr>\
</table>';
    diag.show();
    diag.okButton.parentNode.style.textAlign = "center";
