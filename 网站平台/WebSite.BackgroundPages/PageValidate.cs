...
namespace WebSite.Core
{
    ...
    public class PageValidate
    {
        ...
        #region 是否由特定字符组成
        public static Boolean isContainSameChar(String strInput)
        {
        ...
        public static Boolean isContainSameChar(String strInput, String charInput, int lenInput)
        {
        ...
        /// </summary>
        public static Boolean isContainSpecChar(String strInput)
        {
