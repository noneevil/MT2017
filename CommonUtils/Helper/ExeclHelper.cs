...
{
    public abstract class ExeclHelper
    {
        /// <summary>
        /// 获取Excel数据表列表
        /// </summary>
        ...
        /// <returns></returns>
        public static Boolean OutputToExcel(DataTable Table, String ExcelFilePath)
        {
        ...
        /// <param name="ExcelFilePath">Excel文件路径</param>
        /// <returns></returns>
        public static Boolean OutputToExcel(DataTable Table, ArrayList Columns, String ExcelFilePath)
        {
            if (File.Exists(ExcelFilePath))
            {
                throw new Exception("该文件已经存在！");
