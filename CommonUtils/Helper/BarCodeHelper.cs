...
namespace CommonUtils
{
    ...
    public class BarCodeHelper
    {
        ...
        public static Image MakeBarcodeImage(String InputData, int BarWeight, Boolean AddQuietZone)
        {
    ...
    public static class Code128Code
    {
        ...
        public static Boolean CharCompatibleWithCodeset(int CharAscii, CodeSet currcs)
        {
