var DropList = new Class({
    ...
    initialize: function(options) {
        ...
        this.src = '/developer/zTree.aspx?container=' + options.container + '&multiple=' + options.multiple + '&parent=' + options.parent + '&autopostback=' + options.autopostback;

        this.element.setStyle('background', 'url(<%=WebResource("WebSite.Controls.DropDownList.DropDownList.gif") %>) no-repeat right bottom');
        this.element.addEvents({
            click: this.Show.bind(this),
            mouseenter: function() {
                this.element.setStyle('background', 'url(<%=WebResource("WebSite.Controls.DropDownList.DropDownList.gif") %>) no-repeat right top');
            } .bind(this),
            mouseleave: function() {
                this.element.setStyle('background', 'url(<%=WebResource("WebSite.Controls.DropDownList.DropDownList.gif") %>) no-repeat right bottom');
            } .bind(this)
