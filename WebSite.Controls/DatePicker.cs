    ...
    public class DatePicker : TextBox
    {
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            if (this.ShowMode == DateMode.Date)
                this.Style.Add("background", "url(/admin/images/ico/datepicker.gif) no-repeat right");
            else
                this.Style.Add("background", "url(/admin/images/ico/datetime.gif) no-repeat right");
            if (!DesignMode)
            {
