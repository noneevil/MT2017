            ...
            try
            {
                ...
                if (oFile != null)
                {
                    ...
                    if (Connector.CheckFileName(sFileName) && !Config.Current.CheckIsHiddenFile(sFileName))
                    {
                        ...
                        string sFileNameNoExt = Util.GetFileNameWithoutExtension(sFileName);
                        string sFullExtension = Util.GetExtension(sFileName);
                        int iCounter = 0;
                        ...
                        Int32 count = new DirectoryInfo(sServerDir).GetFiles().Length + 1;
                        sFileName = DateTime.Now.ToString("yyyyMMdd") + count.ToString("D5") + "." + sExtension;
