 ...
 * this file is part of the Source Code of WebSite.Controls.
 */
...
{
    public class Watermark : WebSite.Controls.CKFinderPlugin
    {
        ...
        {
            CKFinderEvent.AfterFileUpload += new CKFinderEvent.Hook(CKFinderEvent_AfterFileUpload);

            if (!Config.Current.PluginSettings.ContainsKey("Watermark_source")) Config.Current.PluginSettings["Watermark_source"] = "logo.gif";
            if (!Config.Current.PluginSettings.ContainsKey("Watermark_marginRight")) Config.Current.PluginSettings["Watermark_marginRight"] = "5";
            if (!Config.Current.PluginSettings.ContainsKey("Watermark_marginBottom")) Config.Current.PluginSettings["Watermark_marginBottom"] = "5";
            if (!Config.Current.PluginSettings.ContainsKey("Watermark_quality")) Config.Current.PluginSettings["Watermark_quality"] = "90";
            if (!Config.Current.PluginSettings.ContainsKey("Watermark_transparency")) Config.Current.PluginSettings["Watermark_transparency"] = "80";
        }

        private void CKFinderEvent_AfterFileUpload(object sender, CKFinderEventArgs e)
        {
        ...
        {
            string logoImageName = (string)Config.Current.PluginSettings["Watermark_source"];
            ...
            int.TryParse((string)Config.Current.PluginSettings["Watermark_marginBottom"], out marginBottom);
            int.TryParse((string)Config.Current.PluginSettings["Watermark_marginRight"], out marginRight);
            if (int.TryParse((string)Config.Current.PluginSettings["Watermark_transparency"], out transparency))
            {
            ...
            //load bitmaps
            System.Drawing.Image sourceImage = new Bitmap(sourceFile);
